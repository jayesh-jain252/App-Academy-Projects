...
// Your code here
unverifiedPayload = jwt.verify(token, "fakeSecret");
console.log("Verified Payload:", unverifiedPayload);
...
// Your code here
setTimeout(() => {
  timeOutPayload = jwt.verify(token, process.env.SECRET_KEY);
  console.log("TimeOut Payload:", timeOutPayload);
}, 1000);
